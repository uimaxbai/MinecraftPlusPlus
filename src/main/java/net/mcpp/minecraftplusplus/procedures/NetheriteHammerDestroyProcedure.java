...
public class NetheriteHammerDestroyProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		for (int index0 = 0; index0 < (int) (Mth.nextInt(new Random(), 5, 8)); index0++) {
		...
		for (int index1 = 0; index1 < (int) (Mth.nextInt(new Random(), 1, 5)); index1++) {
			if (world instanceof Level _level && !_level.isClientSide()) {
		...
		for (int index2 = 0; index2 < (int) (Mth.nextInt(new Random(), 0, 5)); index2++) {
		...
		for (int index3 = 0; index3 < (int) (Mth.nextInt(new Random(), 0, 2)); index3++) {
			if (world instanceof Level _level && !_level.isClientSide()) {
		...
		for (int index4 = 0; index4 < (int) (Mth.nextInt(new Random(), 0, 1)); index4++) {
			if (world instanceof Level _level && !_level.isClientSide()) {
